                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a class="{{$orderBy=='Sort By Newness Date' ? 'active': ''}}" href="#" wire:click.prevent="changeOrderBy('Sort By Newness Date')">Sort By Newness Date</a></li>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            @if($witems->contains($product->id))
                                                <a aria-label="Remove From Wishlist" class="action-btn hover-up wishtisted" href="#" wire:click.prevent="removeFromWishlist( {{$product->id}})"><i class="fi-rs-heart"></i></a>
                                            @else
